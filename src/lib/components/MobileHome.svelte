    ...
    {#if quickPlayAlbums.length > 0}
        <div class="quick-play-grid">
            {#each quickPlayAlbums as album}
                <button class="quick-play-card" on:click={() => goToAlbumDetail(album.id)}>
                    ...
                    <span class="quick-play-name truncate-text">{album.name}</span>
                </button>
            {/each}
        </div>
    {/if}
        ...
        <section class="carousel-section">
            ...
            <div class="carousel-container">
                {#each recentTracks as track, i}
                    <button class="spotify-card" on:click={() => handlePlayTrack(i)}>
                        <div class="card-art">
                            {#if getTrackArt(track)}
                                <img src={getTrackArt(track)} alt={track.title} />
                            {:else}
                        ...
                        <span class="card-title truncate-text">{track.title || 'Unknown'}</span>
                        <span class="card-subtitle truncate-text">{track.artist || 'Unknown Artist'}</span>
                    </button>
                {/each}
            </div>
        </section>
        ...
        <section class="carousel-section">
            ...
            <div class="carousel-container">
                {#each displayAlbums as album}
                    <button class="spotify-card" on:click={() => goToAlbumDetail(album.id)}>
                        <div class="card-art">
                            {#if getAlbumArt(album)}
                                <img src={getAlbumArt(album)} alt={album.name} />
                            {:else}
        ...
        <section class="carousel-section">
            ...
            <div class="carousel-container">
                {#each displayArtists as artist}
                    <button class="spotify-card artist-card" on:click={() => goToArtistDetail(artist.name)}>
                        ...
                        <span class="card-title truncate-text">{artist.name}</span>
